...
def prva_stran():
    c = model.citat()
    return bottle.template('prva_stran.tpl', citat=c, danes_dat=danes_dat)
...
def datumi_na_dlani():
    ...
    if dolzina_vnos < trajanje_vnos or (datum_v_py - razlika(7)) > danes or (danes - datum_v_py) > razlika(365):
        return bottle.template('opozorilo.tpl', citat=c, datum_vnos=datum_vnos, trajanje_vnos=trajanje_vnos, dolzina_vnos=dolzina_vnos, danes_dat=danes_dat)
    else:
        if (danes - datum_v_py) > razlika(dolzina_vnos):
            ...
            return bottle.template('dat2.tpl', citat=c, danes_dat=danes_dat, datum_vnos=datum_vnos, trajanje_vnos=trajanje_vnos, dolzina_vnos=dolzina_vnos, cikel_osebe=cikel_osebe, m1=m1, m2=m2, m3=m3, o1=o1, o2=o2, p1=p1, p2=p2, z1=z1, z2=z2)
        else:
            return bottle.template('dat1.tpl', citat=c, danes_dat=danes_dat, datum_vnos=datum_vnos, trajanje_vnos=trajanje_vnos, dolzina_vnos=dolzina_vnos, cikel_osebe=cikel_osebe, m1=m1, m2=m2, m3=m3, o1=o1, o2=o2, p1=p1, p2=p2)
